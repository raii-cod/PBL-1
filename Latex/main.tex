...
Trước khi tìm hiểu về thuật toán, để hiệu quả điều đầu tiên là nắm vững kiến thức về lý thuyết đồ thị.
...
\subsection{Nguyên lí nới lỏng cạnh (Relaxation)}
...
2 & \texttt{<stdlib.h>} & Cung cấp các hàm tiện ích hệ thống bao gồm lệnh xóa màn hình Console và quản lý thực thi kiểm soát bộ nhớ. \\ \hline
